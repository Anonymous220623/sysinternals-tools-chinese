...
3. 已发现但本人无法解决的问题会列在[已知问题](#已知问题)区域。
...
|--|--|--|--|--|
| [**Process Explorer**](https://learn.microsoft.com/zh-cn/sysinternals/downloads/process-explorer) | v17.06(2024.??.??) | **v17.08(2025.11.20)** | v17.06.012 | [EXE 文件](https://github.com/Anonymous220623/sysinternals-tools-chinese/releases/download/v17.06.012-procexp/procexp64.exe) |
...
- [#1(v17.06.012)：Process Explorer 打开 Process Explorer 进程显示 ASLR 状态有误，其他进程没有此问题](https://github.com/Anonymous220623/sysinternals-tools-chinese/issues/1)
